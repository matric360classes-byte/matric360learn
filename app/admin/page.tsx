...
export default function AdminPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <p className="text-sm opacity-70 mb-6">Supabase Live topic_knowledge: {stats.topics} • lessons: {stats.lessons}</p>
      
      <div className="grid grid-cols-3 gap-4 mb-8">
        <div onClick={() => setShowTopics(!showTopics)} className="border p-4 rounded-lg cursor-pointer hover:bg-gray-100">
