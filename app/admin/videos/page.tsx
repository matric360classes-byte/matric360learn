...
export default function VideosPage(){
  ...
  useEffect(()=>{ (async()=>{
    // YOUR REAL SOURCE - caps_knowledge_base has all topics
  ...
  // BUILD UNITS FROM caps_code - because your table has no unit column
  // e.g. equations-motion -> unit = equations
