...
export async function GET(){
  // List from videos table (your Admin Videos list page)
...
export async function POST(req: NextRequest){
  ...
  // 1. Save to videos table WITHOUT description (this was the crash)
  const row = {
    youtube_id,
    youtube_url,
    caps_topic_id,
    ...
    subject,
    title,
    thumbnail_url: thumbnail_url || `https://i.ytimg.com/vi/${youtube_id}/hqdefault.jpg`,
    order_index: order||0,
    status: status||"Ready",
  ...
  // 2. ALSO save to caps_knowledge_base - THIS is what Student Nodes page.tsx reads
  // Only update columns that exist in caps_knowledge_base
