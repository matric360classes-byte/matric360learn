    ...
    <div style={{background:"#0a0d1a",minHeight:"100vh",color:"white"}}>
      <style>{`
       @media(min-width: 768px){
          ...
          .hero-btns{ flex-direction:row !important; justify-content:flex-start !important; }
        }
      `}</style>
      ...
      {/* HERO + DASHBOARD - LEFT ON DESKTOP LIKE YOUR PHOTO */}
      <div className="hero-wrap" style={{padding:"20px"}}>
        <section className="hero-text" style={{textAlign:"center"}}><div style={{display:"inline-flex",background:"#1a1c32",border:"1px solid #2a2c4a",padding:"6px 14px",borderRadius:999,fontSize:12}}>🟢 CAPS-Aligned · Grade 12</div><h1 style={{fontSize:34,fontWeight:900,lineHeight:1.15,marginTop:16}}>Master Grade 12 Maths<br/>& Physical Sciences<br/>with <span style={{background:"linear-gradient(90deg,#22d3ee,#a855f7)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Confidence</span></h1><p style={{color:"#94a3b8",fontSize:13,marginTop:10}}>Start with CAPS-aligned Grade 12 lessons and build progress step by step.</p><div className="hero-btns" style={{display:"flex",flexDirection:"column",gap:10,marginTop:18}}><Link href="/signup" style={{background:"#fbbf24",color:"black",padding:"16px",borderRadius:16,fontWeight:800,textDecoration:"none",textAlign:"center"}}>✨ Start Studying Free</Link><Link href="#how" style={{background:"#1e2035",color:"white",padding:"14px",borderRadius:16,border:"1px solid #2d304f",textDecoration:"none",textAlign:"center"}}>▷ See How It Works</Link></div></section>
