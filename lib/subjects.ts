  ...
  mathematics: {
    ...
    sections: [
      { title: "Mathematics", units: [
        { id: "number-patterns", unit: "UNIT 1", title: "Number Patterns, Sequences and Series", subTopics: [
        ...
        { id: "functions-inverses", unit: "UNIT 2", title: "Functions and Inverses", subTopics: [
  ...
  physicalSciences: {
    ...
    sections: [
      { title: "Mechanics", units: [
        { id: "vectors", unit: "UNIT 1", title: "Vectors & Scalars", subTopics: [
